        ...
        <nav className="hidden md:flex items-center gap-1.5">
          {NAV_ITEMS.map((item) => {
            ...
            return (
              <button
                key={item.label}
                className="flex items-center gap-2 px-4 py-2.5 text-xs lg:text-[13px] font-bold text-slate-800 bg-transparent hover:bg-gradient-to-r hover:from-blue-950/15 hover:via-blue-900/15 hover:to-amber-950/15 rounded-full transition-all duration-200 active:scale-95 group cursor-pointer"
              >

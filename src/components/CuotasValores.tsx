...
export const CuotasValores: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-6">
      {/* Header Banner */}
      <div className="bg-gradient-to-br from-blue-950 via-blue-900 to-indigo-950 rounded-2xl p-6 sm:p-8 text-white shadow-lg relative overflow-hidden border border-blue-800/40">
          ...
          <div className="flex items-center gap-1 bg-slate-100 p-0.5 rounded-lg">
            <button
              ...
              className={`px-3 py-1 rounded-md transition-all cursor-pointer text-[11px] ${
                matriculaFilter === 'todos' ? 'bg-white text-blue-900 font-bold shadow-sm' : 'text-slate-600 hover:text-slate-900'
              }`}
            >
              Todos
            </button>
            <button
              ...
              className={`px-3 py-1 rounded-md transition-all cursor-pointer text-[11px] ${
                matriculaFilter === 'activa' ? 'bg-emerald-600 text-white font-bold shadow-sm' : 'text-slate-600 hover:text-slate-900'
              }`}
            >
              Matrícula Activa
            </button>
            <button
              ...
              className={`px-3 py-1 rounded-md transition-all cursor-pointer text-[11px] ${
                matriculaFilter === 'mantenimiento' ? 'bg-amber-600 text-white font-bold shadow-sm' : 'text-slate-600 hover:text-slate-900'
              }`}
            >
              Mantenimiento
            </button>
